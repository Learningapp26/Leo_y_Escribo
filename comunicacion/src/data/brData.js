...
export const brWordSyllableSelection = [
  {
    id: 'obra',
    word: 'obra',
    wordAudio: '/audio/lecciones/br/silaba-obra.mp3',
    options: ['bra', 'ba'],
    answer: 'bra',
  },
    {
    id: 'brisa',
    word: 'brisa',
    wordAudio: '/audio/lecciones/br/silaba-brisa.mp3',
    options: ['di', 'bri'],
    answer: 'bri',
  },
    {
    id: 'sobre',
    word: 'sobre',
    wordAudio: '/audio/lecciones/br/silaba-sobre.mp3',
    options: ['bre', 'be'],
    answer: 'bre',
  },
    {
    id: 'bruja',
    word: 'bruja',
    wordAudio: '/audio/lecciones/br/silaba-bruja.mp3',
    options: ['du', 'bru'],
    answer: 'bru',
  },
    {
    id: 'broma',
    word: 'broma',
    wordAudio: '/audio/lecciones/br/silaba-broma.mp3',
    options: ['bo', 'bro'],
    answer: 'bro',
  },
    {
    id: 'bruma',
    word: 'bruma',
    wordAudio: '/audio/lecciones/br/silaba-bruma.mp3',
    options: ['bu', 'bru'],
    answer: 'bru',
  },
    {
    id: 'sobra',
    word: 'sobra',
    wordAudio: '/audio/lecciones/br/silaba-sobra.mp3',
    options: ['bra', 'da'],
    answer: 'bra',
  },
    {
    id: 'cubre',
    word: 'cubre',
    wordAudio: '/audio/lecciones/br/silaba-cubre.mp3',
    options: ['bre', 'de'],
    answer: 'bre',
  },
    {
    id: 'cabrita',
    word: 'cabrita',
    wordAudio: '/audio/lecciones/br/silaba-cabrita.mp3',
    options: ['bri', 'bi'],
    answer: 'bri',
  },
    {
    id: 'libra',
    word: 'libra',
    wordAudio: '/audio/lecciones/br/silaba-libra.mp3',
    options: ['bra', 'ba'],
    answer: 'bra',
  },
